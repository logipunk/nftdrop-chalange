...
const Home = ({collections}: Props)=>{ 
  return (
    <div className=' max-w-7xl mx-auto flex flex-col min-h-screen py-20 px-10 2xl:px-0'>
      <Head>
        <title>NFT Ape Demo</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <h1 className=' mb-10 text-4xl font-extralight'>The NFT 
            <span className=' font-extrabold underline decoration-orange-600/50'> Market Place </span></h1>

      <main className='bg-slate-100 p-10 shadow-xl shadow-orange-400/20'>      
...
// this is for server side rendering purposes 
